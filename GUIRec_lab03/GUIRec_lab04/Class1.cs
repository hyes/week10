...
namespace GUIRec_lab04
{
    ...
    {
        public Rectangle(int Left, int Top, int Right, int Bottom) : base(Left, Top, Right, Bottom)
        {
        }
    ...
    class Triangle : Shape
    {
        ...
        public Triangle(int Left, int Top, int Right, int Bottom) : base(Left, Top, Right, Bottom)
        {
    ...
    class Ellipse : Shape
    {
        public Ellipse(int Left, int Top, int Right, int Bottom) : base(Left, Top, Right, Bottom)
        {
        }
    ...
    class Pie :Shape
    {
        public Pie(int Left, int Top, int Right, int Bottom) : base(Left, Top, Right, Bottom)
        {
        }
